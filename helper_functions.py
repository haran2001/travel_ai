...
def get_video_id(url_or_id):
    """Extract the video ID from a YouTube URL or ID."""
...
def create_youtube_df(video_ids, video_transcripts):
    df = pd.DataFrame(video_ids, video_transcripts)
    df.to_excel("data/travel_youtube.xlsx")
